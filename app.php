...
<!-- Animated Background Layers (generated by JS) -->
<div class="bg-layer bg-stars" id="bg-stars"></div>
<div class="bg-layer bg-orbs" id="bg-orbs"></div>
<div class="bg-layer bg-particles" id="bg-particles"></div>
<div class="bg-layer bg-meteors" id="bg-meteors"></div>
...
<div class="app">
  ...
  <div class="sidebar" id="screen-list">
    <div class="sidebar-head">
      ...
      <div class="theme-switcher" id="theme-switcher">
        <div class="theme-btn theme-night active" data-theme="night" title="ليلي"></div>
        <div class="theme-btn theme-purple" data-theme="purple" title="بنفسجي"></div>
    ...
    <div class="store-chip" id="open-store">
      ...
      <span style="margin-inline-start:auto; color:var(--gold); font-weight:700; display:flex; align-items:center; gap:4px;" id="my-coins">0 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14"><circle cx="12" cy="12" r="10"/><path d="M12 6v12M8 10h8M9 14h6"/></svg></span>
    </div>
  ...
  <div class="chat-screen" id="chat-screen">
    ...
    <div class="gift-panel" id="gift-panel">
      ...
      <div class="gift-balance" id="gift-balance">رصيدك: 0 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="12" height="12" style="vertical-align:middle"><circle cx="12" cy="12" r="10"/><path d="M12 6v12M8 10h8M9 14h6"/></svg></div>
    </div>
  </div>
