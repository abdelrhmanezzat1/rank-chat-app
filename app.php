...
<div class="app">
  ...
  <div class="sidebar" id="screen-list">
    <div class="sidebar-head">
      ...
      <div class="notif-bell" id="admin-btn" title="لوحة التحكم" style="color:var(--gold);">
  ...
  <!-- Admin Panel -->
  <div class="chat-screen" id="admin-screen">
    <div class="chat-topbar">
      <div class="chat-back" id="admin-back">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M9 18l6-6-6-6"/></svg>
      </div>
      <div class="chat-title">
        <div class="name">لوحة التحكم</div>
        <div class="status">إدارة السيرفر</div>
      </div>
    </div>
    <div class="admin-tabs">
      <div class="store-tab active" data-admin-tab="stats">الإحصائيات</div>
      <div class="store-tab" data-admin-tab="users">المستخدمين</div>
      <div class="store-tab" data-admin-tab="reports">البلاغات</div>
      <div class="store-tab" data-admin-tab="mod_log">سجل الإجراءات</div>
    </div>
